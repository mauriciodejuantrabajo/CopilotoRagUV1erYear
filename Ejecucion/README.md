...
This project consists of an AI agent using LLMs + RAG. The system integrates a context-based reasoning LLM model derived from vectorized document retrieval mechanisms and a separate conversational LLM model, achieving a context-aware solution for accurately answering questions.
